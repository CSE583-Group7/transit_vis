#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Module for functions that do not require AWS login info (config).

This is a module containing all functions for visualization that
do not require AWS login so that they can be tested during continuous
integration.
"""
